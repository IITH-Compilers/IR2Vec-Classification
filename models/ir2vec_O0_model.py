...
# Usage Instructions
# python ir2vec_O0_model.py [options]
...
# For Training
# python ir2vec_O0_model.py --train <PATH of the train data file> [--test <Path of the test data file>] [--val <Path of the val data file>] [--epochs XX] [--batch_size YY]
...
# python ir2vec_O0_model.py --data <PATH of the data file> [--test <Path of the test data file>] [--val <Path of the val data file>] [--epochs XX] [--batch_size YY] --model <saved model path>

# For Testing
# python ir2vec_O0_model.py --test <Path of the test data file>  --model <saved model path>
...
def train(x_train, y_train, x_test, y_test, x_val, y_val, options, model):
    ...
    model.save("ir2vec_O0_model.h5")
    print("Saved model to disk --> ir2vec_O0_model.h5")
