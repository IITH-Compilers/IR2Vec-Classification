...
# For Training
# python default_model.py --train <PATH of the train data file> [--test <Path of the test data file>] [--val <Path of the val data file>] [--epochs XX] [--batch_size YY]
...
# python default_model.py --data <PATH of the data file> [--test <Path of the test data file>] [--val <Path of the val data file>] [--epochs XX] [--batch_size YY] --model <saved model path>

# For Testing
# python default_model.py --test <Path of the test data file>  --model <saved model path>
...
def train(x_train, y_train, x_test, y_test, x_val, y_val, options, model):
    ...
    model.save("def_ir2vec_model.h5")
